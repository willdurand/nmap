...
class Nmap
{
     ...
     */
    public function __construct(ProcessExecutor $executor = null, $outputFile = null, $executable = 'nmap', $timeout = 60)
    {
        ...
        if ($this->executor->execute($this->executable.' -h', $timeout) !== 0) {
